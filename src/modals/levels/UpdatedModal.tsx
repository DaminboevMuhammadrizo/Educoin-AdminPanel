...
export default function UpdateLevelModal({ open, onClose, onSuccess, level }: UpdateLevelModalProps) {
        ...
        if (level && open) {
            ...
            const updatedTranslations = translations.map(trans => {
                ...
                return levelTrans ? {
                    ...
                    title: levelTrans.title || '',
                    subTitle: levelTrans.subTitle || '',
                    description: levelTrans.description || ''
                } : trans;
            });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.patch(`${baseUrl}/levels/${level.id}`, payload, {
                headers: {
    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-end bg-black/40" onClick={onClose}>
            <div className="w-full sm:w-[500px] h-full bg-white overflow-y-auto" onClick={e => e.stopPropagation()}>
                <div className="flex justify-between items-center p-4 border-b from-green-50 to-blue-50">
                    <h2 className="text-lg font-semibold text-gray-800">Darajani tahrirlash</h2>
                    <button
                        onClick={onClose}
                                    ...
                                    <div className="flex-1 space-y-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <input
                                                ...
                                                placeholder="FF0000"
                                                className="flex-1 border border-gray-300 rounded-md px-3 py-1.5 text-sm font-mono uppercase focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-all tracking-wider"
                                                maxLength={6}
                                            />
                                            <div
